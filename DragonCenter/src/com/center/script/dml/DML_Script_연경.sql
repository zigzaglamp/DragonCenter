...
insert into tblEmployee (employee_seq,rc_seq,employee_hiredate,employee_insurance,employee_salary) 
     values (
...
select * from tblRecruitInfo inner join tblJobSeeker on tblJobSeeker.rc_seq = tblRecruitInfo.rc_seq
where tblRecruitInfo.ri_salary = tblJobSeeker.js_salary --연봉
--where tblRecruitInfo.company_seq = tblJobSeeker.area_seq --지역
;
