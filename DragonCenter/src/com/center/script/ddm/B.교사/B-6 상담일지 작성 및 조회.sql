...
--------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------
-- tblCounsellog insert trigger
CREATE OR REPLACE TRIGGER trigInsertcounsel
    AFTER
    INSERT ON tblCounselLog
BEGIN
...
--------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------
-- tblCounsellog update trigger
CREATE OR REPLACE TRIGGER trigUpdatecounsel
    AFTER
    UPDATE ON tblCounselLog
BEGIN
...
--------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------
-- tblCounsellog delete trigger
CREATE OR REPLACE TRIGGER trigDeletecounsel
    AFTER
    DELETE ON tblCounselLog
BEGIN
